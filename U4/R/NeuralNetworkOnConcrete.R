...
FFRconcrete_model <- neuralnet(strength ~ cement + slag + ash + water
                               + superplasticizer
                               + coarseagg + fineagg + age,
                               data = concrete_train)
#training the simplest multilayer feed-forward network with
#only a single hidden node
plot(FFRconcrete_model)
